...
def view_result(seq, res, startIndex):
    ...
    rect = plt.Rectangle((x, y), w, h, linewidth=5, edgecolor="#ff0000",
                         zorder=1, fill=False)
    gtRect = plt.Rectangle((gx, gy), gw, gh, linewidth=5, edgecolor="#00ff00",
                           zorder=1, fill=False)
    ...
    ani = animation.FuncAnimation(fig, update_fig, 
                                  frames=len(res), fargs=(startIndex,
                                  res, seq.gtRect, src, seq.startFrame),
